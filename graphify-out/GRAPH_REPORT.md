...
- `useCompanyMutate()` --calls--> `UseClientCompanyManager`  [EXTRACTED]
  playgrounds/labs/src/pages/billing/components/ClientBillingAddresses.vue → packages/headless/src/modules/client-company/useClientCompanyManager.ts
- `build()` --indirect_call--> `navigate()`  [INFERRED]
  playgrounds/labs-nuxt/modules/scenarios/runtime/composables/__tests__/scenario-player.spec.ts → packages/headless/src/modules/routing/useRoutingEngine.ts
...
Cohesion: 0.04
Nodes (60): { storefrontRoute }, { t }, { t }, { t }, { t }, doResolve(), emit, mode (+52 more)
...
Cohesion: 0.06
Nodes (61): mapDisplayDate(), mapEmailHistory(), mapEmailStatus(), mapReceivedEmail(), useQuerySchema(), useQueryUischema(), useSortUischema(), createClientEmailHistoryServices() (+53 more)
...
Cohesion: 0.05
Nodes (58): CancellationRequestStatusCodes, ContractProductsKinds, ContractProductsTypes, PriceType, ProvisionRequestStatusCodes, ConfigurationModes, DeferModes, ProvisionCategoryCodes (+50 more)

### Community 52 - "packages / src / client-vue"
Cohesion: 0.03
Nodes (55): { control, formFieldProps, onInput, handleChange }, onDomainInput(), props, { t }, tester, { layout }, props, tester (+47 more)

### Community 53 - "packages / src / modules"
Cohesion: 0.09
Nodes (58): SmartDomainDrawerProps, parsePromotionsOrCoupons(), DOMAIN_ADD_ERROR_CODE_SET, DOMAIN_ADD_ERROR_CODES, DomainAddErrorCode, addExistingRegistration(), addExistingTransfer(), buildDomainProductFromAvailability() (+50 more)

### Community 54 - "packages / scenario-harness / src"
Cohesion: 0.06
Nodes (54): fixtureSteps, defineSteps(), DuplicatedPattern, FeatureStep, MalformedStepDef, STEP_KIND, StepCatalog, StepCatalogs (+46 more)
...
Cohesion: 0.04
Nodes (44): props, renewalDescription, { t }, emit, props, query, { t }, emit (+36 more)
...
## Knowledge Gaps
- **11664 isolated node(s):** `name`, `private`, `version`, `description`, `Upmind` (+11659 more)
