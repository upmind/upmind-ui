[Upmind](../../packages.md) / [@upmind-automation/headless](../index.md) / usePaymentDetail

# usePaymentDetail()

```ts
function usePaymentDetail(actor): object;
```
...
An object containing the payment gateway state and methods to make a payment.
