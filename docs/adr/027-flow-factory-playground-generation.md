...
Operator rulings recorded in `docs/sdd/FE-2976/review-notes.md`; Linear [FE-2976](https://linear.app/upmind-automation/issue/FE-2976). These amend the Decision text above; the review-panel amendments above stand except where item 2 below narrows decision 10 further.
