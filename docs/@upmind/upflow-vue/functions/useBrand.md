[Upmind](../../packages.md) / [@upmind/upflow-vue](../index.md) / useBrand
...
• **keys**: [`BrandConfigKeys`](../../upflow/enumerations/BrandConfigKeys.md) \| [`BrandConfigKeys`](../../upflow/enumerations/BrandConfigKeys.md)[]

#### Returns

`Promise`\<`Pick`\<`any`, [`BrandConfigKeys`](../../upflow/enumerations/BrandConfigKeys.md)\>\>
