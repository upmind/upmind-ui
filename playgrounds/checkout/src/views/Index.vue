<template>
  ...
  >
    ...
    <h3 class="mt-8 w-full">Types/Variants</h3>
    ...
    <h3 class="mt-8 w-full">Solid Color Variants</h3>
    <div class="flex flex-wrap items-center gap-4">
    ...
    <h3 class="mt-8 w-full">Outlined Color Variants</h3>
    <div class="flex flex-wrap items-center gap-4">
    ...
    <h3 class="mt-8 w-full">Ghost Color Variants</h3>
    <div class="flex flex-wrap items-center gap-4">
    ...
    <h3 class="mt-8 w-full">Plain (Soft) Color Variants</h3>
    <div class="flex flex-wrap items-center gap-4">
    ...
    <h3 class="mt-8 w-full">Elevated Color Variants</h3>
    <div class="flex flex-wrap items-center gap-4">
    ...
    <h3 class="mt-8 w-full">Link Color Variants</h3>
    <div class="flex flex-wrap items-center gap-4">
    ...
    <h3 class="mt-8 w-full">Loading Color Variants</h3>
    <div class="flex flex-wrap items-center gap-4">
    ...
    <h3 class="mt-8 w-full">Disabled Color Variants</h3>
    <div class="flex flex-wrap items-center gap-4">
