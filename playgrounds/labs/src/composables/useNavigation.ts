...
const SECTION_CONFIG: Record<string, { icon: string; order: number }> = {
  Labs: { icon: "beaker-01", order: 1 },
  "Client Management": { icon: "users-01", order: 2 },
  Products: { icon: "shopping-bag-02", order: 3 },
  Invoices: { icon: "receipt", order: 4 },
  Session: { icon: "lock-01", order: 5 },
  Portal: { icon: "user-01", order: 6 },
  Admin: { icon: "shield-01", order: 7 }
};
