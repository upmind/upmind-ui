// -----------------------------------------------------------------------------
/**
 * @module scenarios/useClientEmails/client-email.scenario
 * @description The client-email scenario — ONE module, ONE declaration
 ...
 * segment and the route name (`/useClientEmails`), so nothing here declares a
 ...
 * `/for/:type/:id` segments move it (`R6-30b`).
 */
