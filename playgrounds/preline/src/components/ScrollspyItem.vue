...
<template>
  <div id="scrollspy-scrollable-parent-1" class="max-h-[300px] overflow-auto">
    <header
      class="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-40 w-full bg-white text-sm py-4 dark:bg-gray-800"
    >
      <nav
        ...
        >
          ...
          >
            ...
            <div
              ...
              class="hs-dropdown [--adaptive:none] [--placement:bottom-right]"
            >
              <button
                type="button"
