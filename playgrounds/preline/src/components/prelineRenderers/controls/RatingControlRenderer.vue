<template>
  ...
  >
    <div
      :id="control.id + '-input'"
      class="rating"
      :class="[styles.control.rating.wrapper]"
    >
      <input
        type="radio"
        name="rating"
        class="rating-hidden sr-only"
