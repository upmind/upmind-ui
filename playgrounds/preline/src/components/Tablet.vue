<template>
  <figure :data-theme="activeTheme" class="mx-auto max-w-full w-[768px] h-auto">
    <div
    ...
    >
      <div
        class="bg-base text-base-content max-w-full rounded-[1.25rem] overflow-auto h-[1024px]"
      >
