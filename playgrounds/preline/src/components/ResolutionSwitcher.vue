  ...
  >
    <nav class="flex space-x-1">
      <button
        ...
        :key="resolution"
        type="button"
        class="flex flex-col place-items-center gap-1 text-xs sm:text-sm text-inherit hover:text-black font-medium rounded-lg py-2 px-3 dark:text-neutral-200 dark:hover:text-white dark:hs-tab-active:bg-neutral-800 dark:hs-tab-active:text-neutral-200"
        :class="{
      ...
      <!-- <button
        type="button"
        class="hs-tab-active:bg-white hs-tab-active:text-inherit hs-tab-active:shadow-sm text-xs sm:text-sm text-inherit hover:text-black font-medium rounded-lg py-2 px-3 dark:text-neutral-200 dark:hover:text-white dark:hs-tab-active:bg-neutral-800 dark:hs-tab-active:text-neutral-200 active"
