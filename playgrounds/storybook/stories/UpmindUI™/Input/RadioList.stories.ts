...
// -- components
import { UpwRadioList, UpwInput } from "@upmind-automation/upmind-ui";
...
const meta: Meta<typeof UpwRadioList> = {
  parameters: {
    controls: { exclude: ["layout", "variant", "invalid"] },
  },
  component: UpwRadioList,
...
export default meta;
type Story = StoryObj<typeof UpwRadioList>;

export const Base: Story = {
  render: (args, { updateArgs }) => ({
    components: { UpwRadioList },
    setup() {
      return {
        args,
      };
    ...
    template: `
        <upm-radio-list v-bind="args" @update:modelValue="doUpdate" :value="true" />
    `,
  }),
};
