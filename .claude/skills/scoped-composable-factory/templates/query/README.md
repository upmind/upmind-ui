...
member exclusive to it or overriding the shared factory. See `.claude/skills/scoped-composable-factory/templates/ARMS.md` for
...
├── useModule.actions.{actor}.ts  # opt-in — see .claude/skills/scoped-composable-factory/templates/ARMS.md
├── useModule.context.ts
├── useModule.context.{actor}.ts  # opt-in — see .claude/skills/scoped-composable-factory/templates/ARMS.md
├── useModule.meta.ts
├── useModule.meta.{actor}.ts     # opt-in — see .claude/skills/scoped-composable-factory/templates/ARMS.md
├── useModule.internals.ts
├── index.ts
└── README.md            # this file
```

(`.claude/skills/scoped-composable-factory/templates/ARMS.md` / `.claude/skills/scoped-composable-factory/templates/NOT-APPLICABLE.md` are this template set's own factory-authoring
guidance — they are not copied into a built module.)

No `module.machine.ts` — query-backed, no machine (see `.claude/skills/scoped-composable-factory/templates/NOT-APPLICABLE.md`).
