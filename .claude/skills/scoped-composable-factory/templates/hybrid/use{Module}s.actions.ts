...
// -----------------------------------------------------------------------------
/**
 * @module module/useModules.actions
 ...
 * ONLY shared members; no `useModules.actions.{actor}.ts` file exists yet.
 ...
 */
export function createModulesActions(
