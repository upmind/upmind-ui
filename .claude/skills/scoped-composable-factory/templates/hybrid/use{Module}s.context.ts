...
// -----------------------------------------------------------------------------
/**
 * @module module/useModules.context
...
export function createModulesContext(
   ...
   * See `useModules.context.{actor}.ts` for the arm-side override shape.
   */
...
export type UseModuleContext = ReturnType<typeof createModulesContext>;
