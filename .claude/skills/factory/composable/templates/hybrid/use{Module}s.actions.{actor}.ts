 ...
 * to the `client` actor, or overrides `useModules.actions.ts`'s shared
 * implementation — never as an empty scaffold (clause 2,
 * `code-composables.companion.md` "Variance law"). Otherwise DELETE this
 * file; the armless shared factory in `useModules.actions.ts` suffices. See
 ...
 * `templates/machine/useModules.actions.{actor}.ts`'s own — the worked-example
...
// -----------------------------------------------------------------------------
/**
 * @module module/useModules.actions.client
...
export function createClientModuleActions(service: ModuleServices) {
   ...
   * `useModules.actions.ts`'s shared factory; this arm's version is spread LAST
