...
export const containerVariants = cva(
  `bg-background-control-surface shadow-border-border-control-default hover:shadow-border-border-control-hover text-md autofill control-radius flex items-center gap-3 px-4 py-2 transition-[border-color,opacity,box-shadow] duration-200`,
  {
    variants: {
      width: {
