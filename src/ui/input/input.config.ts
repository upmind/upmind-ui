...
export const containerVariants = cva(
  `bg-control-background border-control text-md autofill flex items-center gap-3 border px-4 py-2 transition-[border-color,opacity,box-shadow] duration-200 ${ringClasses} ${invalidRingClasses}`,
  {
    variants: {
      width: {
