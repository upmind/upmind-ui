...
export const containerVariants = cva(
  `bg-control-surface shadow-border-control-default [&:hover,&:focus-within]:shadow-border-control-hover text-md autofill control-radius flex items-center gap-3 px-4 py-2 transition-[border-color,opacity,box-shadow] duration-200`,
  {
    variants: {
      width: {
