...
export default {
  sonner: {
    neutral: {
      ...
      actionButton: cva(
        "transition-all! duration-200! group-data-[type=neutral]:bg-[var(--color-background-accent-neutral)]! group-data-[type=neutral]:text-[var(--color-text-accent-neutral-contrast)]! group-data-[type=neutral]:hover:opacity-90!"
      ),
      closeButton: cva(
    ...
    success: {
      ...
      actionButton: cva(
        "transition-all! duration-200! group-data-[type=success]:bg-[var(--color-background-accent-success)]! group-data-[type=success]:text-[var(--color-text-accent-success-contrast)]! group-data-[type=success]:hover:opacity-90!"
      ),
      closeButton: cva(
    ...
    danger: {
      ...
      actionButton: cva(
        "transition-all! duration-200! group-data-[type=danger]:bg-[var(--color-background-accent-danger)]! group-data-[type=danger]:text-[var(--color-text-accent-danger-contrast)]! group-data-[type=danger]:hover:opacity-90!"
      ),
      closeButton: cva(
    ...
    warning: {
      ...
      actionButton: cva(
        "transition-all! duration-200! group-data-[type=warning]:bg-[var(--color-background-accent-warning)]! group-data-[type=warning]:text-[var(--color-text-accent-warning-contrast)]! group-data-[type=warning]:hover:opacity-90!"
      ),
      closeButton: cva(
    ...
    info: {
      ...
      actionButton: cva(
        "transition-all! duration-200! group-data-[type=info]:bg-[var(--color-background-accent-info)]! group-data-[type=info]:text-[var(--color-text-accent-info-contrast)]! group-data-[type=info]:hover:opacity-90!"
      ),
      closeButton: cva(
    ...
    promo: {
      ...
      actionButton: cva(
        "transition-all! duration-200! group-data-[type=promo]:bg-[var(--color-background-accent-promo)]! group-data-[type=promo]:text-[var(--color-text-accent-promo-contrast)]! group-data-[type=promo]:hover:opacity-90!"
      ),
      closeButton: cva(
