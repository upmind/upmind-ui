...
export default {
  sonner: {
    neutral: {
      toast: cva(
        "group group-[.toaster]:data-[type=neutral]:text-accent-neutral-muted-contrast! group-[.toaster]:data-[type=neutral]:bg-accent-neutral-muted!"
      ),
      actionButton: cva(
    ...
    success: {
      toast: cva(
        "group group-[.toaster]:data-[type=success]:text-accent-success-muted-contrast! group-[.toaster]:data-[type=success]:bg-accent-success-muted!"
      ),
      actionButton: cva(
    ...
    danger: {
      toast: cva(
        "group group-[.toaster]:data-[type=danger]:text-accent-danger-muted-contrast! group-[.toaster]:data-[type=danger]:bg-accent-danger-muted!"
      ),
      actionButton: cva(
    ...
    warning: {
      toast: cva(
        "group group-[.toaster]:data-[type=warning]:text-accent-warning-muted-contrast! group-[.toaster]:data-[type=warning]:bg-accent-warning-muted!"
      ),
      actionButton: cva(
    ...
    info: {
      toast: cva(
        "group group-[.toaster]:data-[type=info]:text-accent-info-muted-contrast! group-[.toaster]:data-[type=info]:bg-accent-info-muted!"
      ),
      actionButton: cva(
    ...
    promo: {
      toast: cva(
        "group group-[.toaster]:data-[type=promo]:text-accent-promo-muted-contrast! group-[.toaster]:data-[type=promo]:bg-accent-promo-muted!"
      ),
      actionButton: cva(
