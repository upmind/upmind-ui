<template>
  <RadioGroupItem
    ...
    :class="
      cn(
        'focus-visible:ring-ring border-control-border aspect-square h-4 w-4 rounded-full border text-primary-foreground ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
