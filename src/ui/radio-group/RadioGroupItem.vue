<template>
  <RadioGroupItem
    ...
    :class="
      cn(
        ringClasses,
        'ring-offset-background-control-surface shadow-border-border-control text-primary aspect-square h-4.5 w-4.5 rounded-full disabled:cursor-not-allowed disabled:opacity-50',
