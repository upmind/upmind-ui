<template>
  <RadioGroupItem
    ...
    :class="
      cn(
        'focus-visible:ring-ring shadow-border text-primary ring-offset-background aspect-square h-4.5 w-4.5 rounded-full border-none focus:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
