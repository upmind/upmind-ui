...
export const triggerVariants = cva(
  "text-md shadow-border-border-control-default h-auto justify-start gap-2 rounded px-4 py-2 transition-all duration-300",
  {
    variants: {
      width: {
        "2xs": "w-dropdown-2xs",
...
export const contentVariants = cva(
  `${ringClasses} bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 shadow-border-border-control-default z-50 my-1.5 rounded p-0 outline-none`,
  {
    variants: {
      color: {
        base: "",
