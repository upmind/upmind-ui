...
export const itemVariants = cva(
  "data-highlighted:bg-control-active-focus bg-base-background text-control-foreground cursor-pointer! flex w-full items-center rounded px-3 py-2 text-sm",
  {
    variants: {
      color: {
...
export const contentVariants = cva(
  `${ringClasses} bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 my-1.5 rounded border p-0 shadow-md outline-none`,
  {
    variants: {
      color: {
        base: "",
