...
export const numberFieldVariants = cva(
  "group-aria-invalid:ring-invalid! focus-visible:ring-ring text-control-foreground ring-offset-background placeholder:text-muted-foreground group-aria-invalid:ring-2! group-aria-invalid:ring-offset-2! inline-flex w-full rounded-lg border-none bg-transparent text-center font-medium text-inherit file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        flat: "shadow-border",
