...
export const numberFieldVariants = cva(
  `${ringClasses} text-control-foreground placeholder:text-muted-foreground ring-offset-control-surface control-radius inline-flex w-full border-none text-center font-medium text-inherit ring-offset-0 transition-all duration-200 file:border-0 file:bg-transparent file:text-sm file:font-medium focus:ring-offset-2`,
  {
    variants: {
      variant: {
...
export const numberFieldInputVariants = cva(
  "bg-control-surface shadow-control-default hover:shadow-control-hover control-radius",
  {
    variants: {
      variant: {
