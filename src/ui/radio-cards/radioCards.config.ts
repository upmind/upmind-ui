...
export const itemVariants = cva(
  `bg-control-surface text-control-foreground group control-radius shadow-control-default [&:hover,&[data-hover=true]]:shadow-control-hover flex cursor-pointer list-none items-start rounded py-4 pr-4 pl-3 font-normal transition-shadow duration-200 md:my-0 ${ringClasses}`
);
