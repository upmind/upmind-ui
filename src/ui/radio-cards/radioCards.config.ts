...
export const itemVariants = cva(
  `group bg-control-backgroundtext-control-foreground rounded transition-all duration-200 ${ringClasses} flex list-none gap-2 p-3 pr-4`,
  {
    variants: {
      isList: {
        ...
        false:
          "hover:border-control-strong border-control rounded border shadow-sm"
      },
      width: {
        0: "",
