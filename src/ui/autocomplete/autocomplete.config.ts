...
export const anchorVariants = cva(
  `${ringClasses} ${invalidRingClasses} w-dropdown-2xs shadow-control-default flex items-center justify-between rounded pr-3 leading-none transition-all duration-200 outline-none`,
  {
    variants: {
      size: {
