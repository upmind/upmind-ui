...
export const rootVariants = cva(
  `ring-offset-background relative inline-flex items-center whitespace-nowrap no-underline transition-all duration-300`,
  {
    variants: {
      ...
      variant: {
        primary:
          "from-background-button-primary0 to-background-button-primary1 bg-gradient-to-br",
        secondary:
          "from-background-button-secondary0 to-background-button-secondary1 bg-gradient-to-br",
        neutral:
          "from-background-button-neutral0 to-background-button-neutral1 bg-gradient-to-br",
        subtle:
          "from-background-button-subtle0 to-background-button-subtle1 bg-gradient-to-br",
        danger:
          "from-background-button-danger0 to-background-button-danger1 bg-gradient-to-br",
