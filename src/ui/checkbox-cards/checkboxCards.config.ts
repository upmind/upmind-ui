...
export default {
  checkboxCards: {
    ...
    item: cva(
      `text-control-foreground group shadow-control-default [&:hover,&[data-hover=true]]:shadow-control-hover bg-control-surface control-radius flex items-start gap-2 rounded-none py-4 pr-4 pl-3 font-normal transition-shadow duration-200 data-[disabled]:pointer-events-none ${ringClasses} ${invalidRingClasses}`,
      {
        variants: variants,
        defaultVariants: {
          columns: 1
