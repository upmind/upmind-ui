...
<template>
  ...
  >
    <SwitchThumb
      :class="
        cn(
          'data-[state=checked]:bg-control-checked data-[state=unchecked]:bg-control-unchecked pointer-events-none block h-5 w-5 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0'
        )
      "
    />
  </SwitchRoot>
