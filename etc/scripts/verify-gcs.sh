...
#
# Usage:
#   bash etc/scripts/verify-gcs.sh --bucket upmind-cart --prefix production [--dist dist]
#
# Examples:
#   # Check production cart
#   bash etc/scripts/verify-gcs.sh --bucket upmind-cart --prefix production
#
#   # Check velia
#   bash etc/scripts/verify-gcs.sh --bucket upmind-cart --prefix velia
