...
8. **Locator preference order: `getByTestId` → `getByRole` → `getByText` → `getByPlaceholder`.** Add a `data-testid` to the frontend rather than fall back. Source: [02-project-structure.md:74-86](./02-project-structure.md#L74-L86); [04-writing-tests.md:118-128](./04-writing-tests.md#L118-L128).
