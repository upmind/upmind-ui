...
// `tests/fixtures/recordings/post-payments.json` (new-card Stripe inline path).
type PaymentPost = {
...
**New-card branch (Stripe inline)** — captured shape from a real run (see `tests/fixtures/recordings/post-payments.json`):
