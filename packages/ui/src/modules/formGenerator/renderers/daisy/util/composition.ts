 ...
 */
export const useDaisyControl = <I extends { control: any; handleChange: any }>(
  input: I,
 ...
 */
export const useDaisyLayout = <I extends { layout: any }>(input: I) => {
  const appliedOptions = computed(() =>
    merge(
      {},
 ...
 * Adds styles and appliedOptions
 */
export const useDaisyLabel = <I extends { label: any }>(input: I) => {
  const appliedOptions = computed(() =>
    merge(
      {},
 ...
 */
export const useDaisyArrayControl = <I extends { control: any }>(input: I) => {
  const appliedOptions = computed(() =>
    merge(
      {},
      cloneDeep(input.control.value.config),
