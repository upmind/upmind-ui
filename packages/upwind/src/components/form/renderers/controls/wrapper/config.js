...
export default {
  ...
  feedback: {
    ...
    error: upwConfig("text-error flex items-center gap-x-3"),
    description: upwConfig("text-base-content flex items-center gap-x-2"),
    transition: {
      enter: {
  ...
  attributes: {
    size: {
      target: "root",
      options: {
        sm: upwConfig("text-sm"),
        default: upwConfig(""),
        lg: upwConfig("text-lg"),
      },
    },
  },
};
