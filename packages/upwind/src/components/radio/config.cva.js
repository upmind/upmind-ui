...
export default {
  radio: {
    ...
    input: cva(
      "border-base-300 focus:border-primary focus:ring-primary size-full shrink-0 appearance-none rounded-[100%] border outline-none ring-0 focus:ring-4 focus:ring-opacity-20",
      {
        variants: {
          isDisabled: {
            true: "bg-base-100 ",
