...
export default {
  autocomplete: {
    ...
    item: cva(
      "data-[disabled]:text-control-disabled relative flex select-none items-center justify-between rounded-md px-3 py-2 text-sm text-control-foreground data-[disabled]:pointer-events-none data-[highlighted]:bg-base-100 data-[highlighted]:outline-none"
    ),
    indicator: cva("pr-2"),
  },
};
