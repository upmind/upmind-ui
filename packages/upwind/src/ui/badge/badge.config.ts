...
export const badgeVariants = cva(
  "focus:ring-ring inline-flex items-center whitespace-nowrap rounded-full border font-semibold leading-none transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2",
  {
    variants: {
      variant: {
