...
export const badgeVariants = cva(
  "focus:ring-ring inline-flex w-fit items-center whitespace-nowrap rounded-3xl border font-semibold leading-none transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2",
  {
    variants: {
      variant: {
