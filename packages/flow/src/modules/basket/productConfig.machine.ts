...
export default createMachine(
  {
    ...
    initial: "loading",
    context: {
      product: null, // this starts life as an id, then is updated to the full product object from the DB,
      // ---
      ...
      setAvailable: assign({
        available: ({ product, selected }, { data }) => {
          return {
            ...
            attributes: useProductAttributesParser(product.products_attributes)
          };
        }
      }),
