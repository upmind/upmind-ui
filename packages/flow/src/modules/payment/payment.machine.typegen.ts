...
export interface Typegen0 {
  ...
  invokeSrcNameMap: {
    "src of the sub machine type, eg: Stripe": "done.invoke.paymentManager.processing:invocation[0]";
  };
  ...
  eventsCausingActions: {
    clearError: "RETRY";
    setError: "error.platform.paymentManager.processing:invocation[0]";
    setFeedbackError: "error.platform.paymentManager.processing:invocation[0]";
