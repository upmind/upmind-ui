...
// -----------------------------------------------------------------------------
/**
 * @module client-notes/useClientNoteManager.internals
 ...
 */
export function createClientNoteManagerInternals(
...
export type UseClientNoteManagerInternals = ReturnType<
  typeof createClientNoteManagerInternals
>;
