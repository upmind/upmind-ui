...
// -----------------------------------------------------------------------------
/**
 * @module client-company/useClientCompanyManager.internals
 ...
 */
export function createClientCompanyManagerInternals(
...
export type UseClientCompanyManagerInternals = ReturnType<
  typeof createClientCompanyManagerInternals
>;
