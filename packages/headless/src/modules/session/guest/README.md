...
To use the **Guest Manager** module, you can import it from the `@upmind/headless` package in your JavaScript project.
...
```javascript
import { useGuest as useUpmindGuest } from `@upmind/headless`;
