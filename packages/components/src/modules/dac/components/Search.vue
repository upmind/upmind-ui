<template>
  <div
    ...
    class="input input-bordered overflow-hidden focus-within:input-primary group/dac-search"
  >
    <div class="join h-full w-full items-center relative">
      <!-- icon -->
      <magnifying-glass-icon
        :class="[compact ? 'w-5 h-5 ml-2' : 'w-7 h-7 ']"
        class="join-item text-inherit group-focus-within/dac-search:text-primary"
      />
      ...
      <input
        ...
        :class="[compact ? 'ml-2 px-2' : 'mx-6 px-4']"
      ...
      <button
        ...
        class="btn btn-primary opacity-50 group-focus-within/dac-search:opacity-100"
        tabindex="-1"
      >
